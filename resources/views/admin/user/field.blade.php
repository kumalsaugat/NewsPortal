<div class="card-body">
    <div class="row">
        ...
        <div class="col-md-6">
            {{-- Username Field --}}
            <div class="mb-3">
                <label for="name" class="form-label"><strong>@lang('app.user.name'):<span
            ...
            @if (!$isEdit)
                <div class="mb-3">
                    <label for="password" class="form-label"><strong>@lang('app.user.password'):<span
                                class="text-danger">*</span></strong></label>
            ...
            {{-- Phone Field --}}
            <div class="mb-3">
                <label for="phone" class="form-label"><strong>@lang('app.user.phone'):<span
                            class="text-danger">*</span></strong></label>
