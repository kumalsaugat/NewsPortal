            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ Breadcrumbs::render('news-category.index') }}
                    </li>
                </ol>
            </div>
        </div> <!--end::Row-->
...
{!! $dataTable->scripts() !!}
    ...
    <script>
        ...
        setupBulkActions({
            ...
            updateUrl: '/news-category/bulk-update-status', // URL for update status
            deleteUrl: '/news-category/bulk-delete' // URL for delete
        });
    </script>
